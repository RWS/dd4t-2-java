...
public class AbstractComponentPresentationController {
    ...
    String componentViewName, @PathVariable final int componentId, final HttpServletRequest request) {
        LOG.debug(">> {} component with viewPrefix: {}, viewName: {} and componentId: {}", new Object[]{request
                .getMethod(), componentViewPrefix, componentViewName, componentId});
        ...
        if (componentPresentation == null || componentPresentation.isDynamic()) {
            ...
            if (componentPresentation != null) {
                try {
                    ...
                    componentPresentation = componentPresentationFactory.getComponentPresentation(new TCMURI(ctUri
                            .getPublicationId(), componentId, 16, 0).toString(), componentPresentation
        ...
        LOG.debug("Rendering component presentation with template '{}' and component id '{}'", componentViewName,
                componentId);
