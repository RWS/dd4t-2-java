    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException,
        ...
        try {
            ...
            if (!url.endsWith(".html")) {
                ...
                BinaryVariantDAO metaDao = (BinaryVariantDAO) StorageManagerFactory.getDAO(200, StorageTypeMapping
                        .BINARY_VARIANT);
                ...
                if (file.exists()) {
                    if (LOGGER.isDebugEnabled()) {
                        LOGGER.debug("Existing file has timestamp of " + file.lastModified() + " versus broker " +
                                "timestamp " + item.getLastPublishDate().getTime());
                    }
                ...
                if (refresh) {
                    BinaryContentDAO dao = (BinaryContentDAO) StorageManagerFactory.getDAO(200, StorageTypeMapping
                            .BINARY_CONTENT);
